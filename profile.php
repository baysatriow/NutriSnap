                                    ...
                                    <form action="#">
                                        <div class="half-input-wrapper">
                                            <div class="single">
                                                ...
                                                <input id="f-name" type="text" placeholder="Bayu">
                                            </div>
                                            <div class="single">
                                                <label for="l-name">Nama Belakang</label>
                                                <input id="l-name" type="text" placeholder="Wibowo">
                                            </div>
                                        </div>
                                        <div class="half-input-wrapper">
                                            <div class="single">
                                            ...
                                            <div class="single">
                                                ...
                                                <input id="phonenumber" type="text" placeholder="+62 xxx xxx xxx">
                                            </div>
                                        </div>
                                        <div class="single">
                                            <label for="message">Bio</label>
                                            <textarea name="" id="message" cols="30" rows="10" placeholder="SS"></textarea>
                                        </div>
                                        <button class="rts-btn btn-primary mt--20">Update Profile</button>
                                    </form>
                                </div>
                            </div>
                        </div>
