...
$pengamanan = ["Informasi Publik", "Informasi Internal", "Informasi Eksternal", "Rahasia"];
$petugas = ["Khotib", "Protokoler", "Muadzin", "Bilal", "Imam"];

$status = ["0" => "TIDAK AKTIF", "1" => "TERBITKAN", "2" => "DRAFT"];
